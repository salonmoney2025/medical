...
export const Card: React.FC<CardProps> = ({
  ...
  const variantStyles = {
    default:
      'bg-white border border-black-200 shadow-sm hover:shadow-md',
    elevated:
      'bg-white border border-black-100 shadow-lg hover:shadow-xl',
    bordered:
  ...
  return (
    ...
    >
      {title && (
        <div className="flex items-center gap-3 mb-4 pb-3 border-b border-black-100">
          {icon && (
